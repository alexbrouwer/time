...
final class Factory
{
    ...
    /**
     * Holds the last errors generated by createFromFormat
     *
     * @var array
     */
     ...
     *
     * If $hour is null it will be set to its now() vale and the default values for $minute and $second will be their now() values.
     * If $hour is not null then the default values for $minute and $second will be 0 (zero).
     *
     ...
     * @return DateTimeZone
     */
    private static function safeCreateDateTimeZone($object): DateTimeZone
    {
        if ($object === null) {
